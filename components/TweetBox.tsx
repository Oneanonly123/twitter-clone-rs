...
function TweetBox({ setTweets }: Props) {
  ...
  const addImageToTweet = (
    ...
    (imageInputRef.current.value = ""), setimageUrlBoxIsOpen(false);
  };

  return (
    <div className="lg:flex space-x-0 lg:p-5">
      <img
        ...
        <form className="flex flex-1 flex-col">
          ...
          <div className="flex items-center">
            ...
            <button
              ...
              className="bg-twitter disabled:opacity-40 mr-2 px-5 py-2 font-bold text-white rounded-full"
            >
              Tweet
            </button>
          </div>
